...
controller.hears('^help','direct_message',function(bot,message) {
        ...
        bot.reply(message, "I\'m on my way");

});
controller.hears('work','direct_message',function(bot,message) {

        bot.reply(message, "How is work?");
...
controller.hears('sad','direct_message',function(bot,message) {
        ...
        bot.reply(message, "Oh No! How can I help?");
